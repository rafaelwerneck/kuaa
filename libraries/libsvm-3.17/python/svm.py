...
fillprototype(libsvm.svm_train_dbc, POINTER(svm_model), [POINTER(svm_problem), POINTER(svm_parameter)]) # PEDRORMJUNIOR
fillprototype(libsvm.svm_train_sh, POINTER(svm_model), [POINTER(svm_problem), POINTER(svm_parameter), c_int]) # BERNARDO BASED ON PEDRO 3.14 CODE (18/08/2013)
...
fillprototype(libsvm.svm_predict_values_sh, c_double, [POINTER(svm_model), POINTER(svm_node), POINTER(c_double)]) # BERNARDO BASED ON PEDRO 3.14 CODE (18/08/2013)
