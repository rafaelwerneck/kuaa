...
call(["./prepareLibSVM.sh", "clean"], cwd="{0}".format(dirname))
call(["./prepareLibSVM.sh"], cwd="{0}".format(dirname))
call(["./prepareLib1VS.sh", "clean"], cwd="{0}".format(dirname))
call(["./prepareLib1VS.sh"], cwd="{0}".format(dirname))
import Classifier
import SVM
import svmutil
