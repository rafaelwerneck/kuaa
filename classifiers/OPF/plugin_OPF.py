...
def distance(distance_name, descriptor_name):
    result = ""
    if distance_name == "Descriptor":
        result = descriptor_name
    elif distance_name == "distance/minkowski.xml":
        result = "minkowski"
    elif distance_name == "distance/standardized_euclidean":
        result = "seuclidean"
    elif distance_name == "distance/mahalanobis":
        result = "mahalanobis"
    elif distance_name == "distance/weighted_minkowski":
        result = "wminkowski"
    elif distance_name == "Manhattan":
        result = "cityblock"
    elif distance_name == "Squared Euclidean":
        result = "sqeuclidean"
    elif distance_name == "Bray-Curtis":
        result = "braycurtis"
    elif distance_name == "Rogers-Tanimoto":
        result = "rogerstanimoto"
    elif distance_name == "Russell-Rao":
        result = "russellrao"
    elif distance_name == "Sokal-Michener":
        result = "sokalmichener"
    elif distance_name == "Sokal-Sneath":
        result = "sokalsneath"
    else:
...
def classify(images, classes_list, train_set, test_set, pos_fold, descriptor,
    ...
    #Classification
    #--------------------------------------------------------------------------
    opf = OPF.OPF(distance=dist)
    
    #Fit
    print "\tFit: Beginning"
    opf.fit(list_train, list_train_class)
    print "\tFit: Done!"
    
    #Save configuration of the OPF
    model_paths = joblib.dump(opf, model_path)
    
    #Predict
    print "\tPredict: Beginning"
    list_predict = opf.classify(list_test)
    print "\tPredict: Done"
